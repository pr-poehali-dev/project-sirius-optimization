...
const platforms: Platform[] = [
  {
    name: "Spotify",
    url: "https://open.spotify.com/artist/NXUMXV",
    iconName: "Music",
    color: "from-green-500 to-green-600",
  },
  {
    name: "YouTube Music",
    url: "https://music.youtube.com/channel/NXUMXV",
    iconName: "Youtube",
    color: "from-red-500 to-red-600",
  },
  {
    name: "Apple Music",
    url: "https://music.apple.com/artist/nxumxv",
    iconName: "Music2",
    color: "from-pink-500 to-rose-600",
  },
  {
    name: "SoundCloud",
    url: "https://soundcloud.com/nxumxv",
    iconName: "Cloud",
    color: "from-orange-500 to-orange-600",
  },
  {
    name: "Deezer",
    url: "https://www.deezer.com/artist/nxumxv",
    iconName: "Disc3",
    color: "from-purple-500 to-purple-600",
  },
  {
    name: "Yandex Music",
    url: "https://music.yandex.ru/artist/nxumxv",
    iconName: "Radio",
    color: "from-yellow-500 to-yellow-600",
  },
  {
    name: "VK Music",
    url: "https://vk.com/artist/nxumxv",
    iconName: "AudioWaveform",
    color: "from-blue-500 to-blue-600",
  },
  {
    name: "Bandcamp",
    url: "https://nxumxv.bandcamp.com",
    iconName: "Disc",
